...
namespace DbHelper
{
    ...
    /// 
    /// </summary>
    public partial class PG_MakeSql
    {
        /// <summary>
        ...
        public string OutSqlString()
        {
            ...
            {
                case SqlStringType.SELECT: SqlString = OutSelectSQL();
                    break;
                case SqlStringType.INSERT: SqlString = OutInsertSQL();
                    break;
                case SqlStringType.UPDATE: SqlString = OutUpdateSQL();
                    break;
                case SqlStringType.DELETE: SqlString = OutDelSQL();
                    break;
            }
            return SqlString;
        }
        ...
        private FieldType SetFieldType(Type T)
        {
            ...
            switch (T.ToString())
            {
                case "System.Decimal": FT = FieldType.INT;
                    break;
                case "System.Int32": FT = FieldType.INT;
                    break;
                case "System.String": FT = FieldType.STR;
                    break;
                case "System.DateTime": FT = FieldType.DATE;
                    break;
                default: FT = FieldType.STR;
                    break;
            }
            return FT;
        }
        ...
        public string GetDataTableForSqlToPager(int UserNum, int UserListIndex)
        {
            ...
            return OutSqlString() + "  limit " + UserNum + " offset " + beginNum + " ;";

            //throw new Exception(sqlString);

        }

        public string SetSqlToPager(string SQL,int UserNum, int UserListIndex)
        {
            int beginNum = (UserListIndex - 1) * (UserNum);
            return SQL + "  limit " + UserNum + " offset " + beginNum + " ;";
