...
function mountListPickerPlungin($, window, document, undefined) {
...
function mountPopupPickerPlungin($, document) {
...
function mountDateTimePickerPlungin($, document) {
...
function mountAllPickers() {
  mountListPickerPlungin(window.mui || window, window, document, undefined)
  mountPopupPickerPlungin(window.mui, document)
  mountDateTimePickerPlungin(window.mui, document)
}

export default mountAllPickers
export {
  mountListPickerPlungin,
  mountPopupPickerPlungin,
  mountDateTimePickerPlungin,
  mountAllPickers
}
