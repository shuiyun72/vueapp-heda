<template>
  <div class="mui-content index_container">
    ...
    <div class="audio" @click="audioPause" :style="'background: url(static/images/'+audioSrc+') no-repeat  center center'">
...
export default {
  ...
  mounted() {
    ...
    this.eventCountPatrol =  JSON.stringify(this.OrdersMsg) !== "{}" ? this.OrdersMsg.eventCountPatrol : undefined ;
    this.memoryCountPatrol = this.eventCountPatrol;
    this.eventCountSelfTask = JSON.stringify(this.OrdersMsg) !== "{}" ? this.OrdersMsg.eventCountSelfTask : undefined ;
    this.memoryCountSelfTask = this.eventCountSelfTask;
    this.eventCountOrders = JSON.stringify(this.OrdersMsg) !== "{}" ? this.OrdersMsg.eventCountOrders : undefined ;
  ...
  methods: {
    ...
    updateOrdersMsg(num,trueData){ 
      ...
      Promise.all([this.getEventCount,this.getSelfTask,this.getOredes]).then(res=>{
        console.log(this_.OrdersMsg)
        if(
           JSON.stringify(this.OrdersMsg) === "{}" &&  this_.eventCountOrders && this_.eventCountSelfTask && this_.eventCountPatrol
        ){
          this_.OrdersMsg = {
          ...
          if(trueData != undefined){
            console.log(num)
            if(num == 1){ 
              if( this_.memoryCountOrders < trueData && this_.eventCountOrders != undefined){
                //发送消息推送
                console.log("//发送消息推送")
              ...
              if( this_.memoryCountPatrol < trueData && this_.eventCountPatrol != undefined ){
                //发送消息推送
                console.log("//发送消息推送")
        ...
        apiMaintain
          ...
          .then(res => {
            if (res.data.Flag) {
              ...
              this_.$set(this_.OrdersMsg,"eventCountOrders",this_.eventCountOrders)
        ...
        apiMaintain
          ...
          .then(res => {
            ...
            if (res.data.Flag) {
              ...
              this_.$set(this_.OrdersMsg,"eventCountSelfTask",this_.eventCountSelfTask)
        ...
        apiInspection
          ...
          .then(res => {
            if (res.data.Flag) {
              ...
              this_.$set(this_.OrdersMsg,"eventCountPatrol",this_.eventCountPatrol)
